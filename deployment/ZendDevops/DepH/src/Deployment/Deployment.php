...
use Zx\DepH\Log\LogAwareInterface;
...
class Deployment implements EventManagerAwareInterface, LogAwareInterface{
    ...
    /**
     * @see \Zx\DepH\Log\LogAwareInterface::setLog()
     */
    public function setLog(\Zx\DepH\Log\Log $log) {
        $this->log = $log;
    }
     ...
     * 
     * @throws \Zx\DepH\File\Exception\RuntimeException
     * @return int 
     */
